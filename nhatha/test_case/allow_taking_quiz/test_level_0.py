...
class TestLevel0(unittest.TestCase):
    ...
    def test_1(self):
        course_name = "Mindful course creation"
        quiz_name = "Quiz 1"
        open_date = datetime.datetime(2023, 5, 6, 14, 0)
        close_date = datetime.datetime(2023, 5, 6, 14, 30)
        out_of_attempt = True
        restriction = "None"
    ...
    def test_3(self, course_name, quiz_name, open_date, close_date, out_of_attempt, restriction):
        ...
        close_date = datetime.datetime(2023, 5, 6, 14, 30)
        out_of_attempt = False
        restriction = "someone@example.com"
        Setup.setup_quiz(self.page, course_name, quiz_name, open_date, close_date, out_of_attempt, restriction)
        Setup.access_course(self.page, course_name)
    ...
    def test_4(self, course_name, quiz_name, open_date, close_date, out_of_attempt, restriction):
        ...
        quiz_name = "Quiz 4"
        open_date = datetime.datetime(2023, 5, 6, 14, 0)
        close_date = datetime.datetime(2023, 6, 6, 14, 30)
        out_of_attempt = True
        restriction = "None"
        Setup.setup_quiz(self.page, course_name, quiz_name, open_date, close_date, out_of_attempt, restriction)
        Setup.access_course(self.page, course_name)
